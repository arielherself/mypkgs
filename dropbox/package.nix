...
assert lib.elem pkgs.stdenv.hostPlatform.system platforms;
...
pkgs.buildFHSEnv {
  ...
  targetPkgs = pkgs: with pkgs; with xorg; [
    ...
    # Self-updating will cause the missing of libGL.so.1
    libGL
  ];
  ...
  runScript = pkgs.writeScript "install-and-start-dropbox" ''
